...
KCM.SimpleKCM {
    ...
    property alias cfg_hideSearchBar: hideSearchBarCheckbox.checked
    ...
    Kirigami.FormLayout {
        ...
        QQC2.CheckBox {
            id: hideSearchBarCheckbox
            text: i18nc("@option:check", "Hide search bar") // qmllint disable unqualified
        }
